  ...
  submit:function(){
    ...
    Dialog.confirm({
      ...
      .then(() => {
       // on confirm
        wx.request({
          url: 'http://118.24.196.69:20015/api/HTSC_Case/IsFiling', 
          method:'post',
          data: JSON.stringify({
            'userid': "8001", 
            'casereturnreason': '',
      ...
      Dialog.confirm({
          ...
          .then(() => {
            ...
            wx.request({
              ...
              data: JSON.stringify({
                'userid': "8001", 
               'caserejectreason': this.data.Reason,
               'casereturnreason': '',
               'pid':that.data.editData.PID,
               'istype': 1
                }),
              ...
              success :(res)=> {
               Notify({ type: 'success', message: '成功不受理此案件！' });
                setTimeout(()=>{
                    wx.navigateBack({
                      delta: 1,
                    })
      ...
      Dialog.confirm({
          ...
          .then(() => {
            ...
            wx.request({
              ...
              data: JSON.stringify({
               'userid': "8001", 
               'casereturnreason': this.data.Reason,
               'pid':that.data.editData.PID,
               'istype': 1,
               'caserejectreason': ''
                }),
              ...
              success :(res)=> {
               Notify({ type: 'success', message: '成功退回上报案件!' });
                setTimeout(()=>{
                    wx.navigateBack({
                      delta: 1,
                    })
