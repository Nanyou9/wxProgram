...
Page({
    ...
    onSearch:function(){
      wx.request({
        url: 'http://118.24.196.69:20015/api/HTSC_Case/GetPageCaseSupervisionList', //仅为示例，并非真实的接口地址
        method:'post',
        data: {
            "rows":this.data.rows,
            "userid":'8001',
    ...
    edit:function(e){
      ...
      wx.navigateTo({                  
        url: '/packageA/pages/ProblemAcceptConfirm/index?editData=' + edit
      })
    },
    accept:function(e){
    ...
    verify: function (e){
        ...
        console.log(edit)
        wx.navigateTo({                  
          url: '/packageA/pages/InspectionConfirm/index?editData=' + edit
        })
    },
    frushData: function () {
        wx.request({
